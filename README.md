...
[![Thumbnail for my projet]Screenshot 2026-02-22 at 8.33.31 PM.png)](https://youtube.com/shorts/b_8TaRahVF4?feature=share
)

## Story Description

In this project I added Images of Mt Fuji from different locations and times. A filter was applied and the image changed. The music was applied and goes through all of the images.

## Image Filter Analysis

The Saturate Filter is used to adjust color based on saturation factor. The makeNegative filter is used to create a negative version of the image by subtracting the current color values by 225
